		...
		<>
			...
			<section className="about-hero">
				<div className="container hero-content">
					...
					<p className="lede">
						At Mears Law, we provide comprehensive legal and consulting services
						tailored to the needs of corporations, government entities, and
						individuals. Our team combines legal and compliance insight with
						practical solutions to help clients navigate complex challenges with
						confidence.
					</p>
          ...
          <div className="col prose">
			...
			<section className="commitment patterned-section">
				<div className="container">
					...
					<p className="sub">
						At Mears Law, we measure success by the trust and confidence our
						clients place in us. We are committed to delivering legal services
					...
					<div className="pill-grid">
						<div className="pill">
							<h4>Excellence</h4>
							<p>
								We provide precise, insightful, and efficient legal solutions
						...
						<div className="pill">
							...
							<p>
								...
								craft strategies that support their success.
							</p>
						</div>
						<div className="pill">
							<h4>Innovation</h4>
							<p>
								We embrace technology, including AI and digital legal tools, to
								enhance service quality, accessibility, and efficiency.
							</p>
						</div>
					</div>

					<p className="note">
						Our commitment is to be more than legal advisors—we strive to be
						trusted partners in every step of your journey.
					</p>
				</div>
			</section>
			...
			<section className="values">
				<div className="container">
					<h2>Our Values</h2>
					<p className="sub">
						At Mears Law, we provide comprehensive legal services tailored to
						the needs of corporations, government entities, and individuals. Our
						team combines legal insight with practical solutions to help clients
				...
				<div className="container">
					...
					<div className="person">
						<div className="meta">
							...
							<div className="bio">
								<p>
									Carissa Mears is the founder of Mears Law. With nearly a
									decade of legal experience across Ontario, Jamaica, and
									Trinidad &amp; Tobago, Carissa brings a global perspective and
									deep cross-border expertise to her practice. Her career spans
									impactful roles in both the public and private sectors,
									including leadership positions at TELUS and the Center for AI
									and Digital Policy, where she has shaped policy and governance
									frameworks for emerging technologies. She has also contributed
									to major transactions and data breach matters as a legal
									consultant at Deloitte, and served as legal counsel to
									organizations such Medic Alert and as a privacy consultant at
									CIBC.
								</p>
								<p>
									Carissa is a recognized thought leader in AI and privacy law,
									frequently invited to speak at industry conferences alongside
									experts from Google, EY, and leading law firms. Her work has
									been cited by policymakers and featured in global initiatives,
									including contributions to the Artificial Intelligence and
									Democratic Values Index and policy submissions to the United
									Nations and European Union.
								</p>
								<p>
									At Mears Law, Carissa manages a practice committed to
									excellence, integrity, and innovation. She works closely with
									clients—from individuals navigating real estate and
									immigration matters to businesses and government entities
									facing complex regulatory and commercial challenges. Her
									approach is grounded in collaboration, clarity, and a deep
									understanding of both legal frameworks and client goals—making
									her a trusted advisor in today’s evolving legal landscape.
								</p>
							</div>
						</div>
					</div>
